...
export const WRITE_DOCSTRING_URL        = 'https://prod-api.trelent.net/docs/docstring';
export const GET_CHECKOUT_URL           = 'https://prod-api.trelent.net/billing/checkout?billing_plan=1';
export const GET_PORTAL_URL             = 'https://prod-api.trelent.net/billing/portal';
export const CHECKOUT_RETURN_URL        = `https://prod-api.trelent.net/redirect?redirect_url=${encodeURIComponent(CHECKOUT_REDIRECT)}`;
export const PORTAL_RETURN_URL          = `https://prod-api.trelent.net/redirect?redirect_url=${encodeURIComponent(PORTAL_REDIRECT)}`;
...
//export const GET_CHECKOUT_URL           = 'https://dev-api.trelent.net/billing/checkout?billing_plan=1';
//export const GET_PORTAL_URL             = 'https://dev-api.trelent.net/billing/portal';
//export const CHECKOUT_RETURN_URL        = `https://dev-api.trelent.net/redirect?redirect_url=${encodeURIComponent(CHECKOUT_REDIRECT)}`;
//export const PORTAL_RETURN_URL          = `https://dev-api.trelent.net/redirect?redirect_url=${encodeURIComponent(PORTAL_REDIRECT)}`;
...
//export const GET_CHECKOUT_URL           = 'http://localhost:8000/billing/checkout?billing_plan=1';
//export const GET_PORTAL_URL             = 'http://localhost:8000/billing/portal';
//export const CHECKOUT_RETURN_URL        = `http://localhost:8000/redirect?redirect_url=${encodeURIComponent(CHECKOUT_REDIRECT)}`;
//export const PORTAL_RETURN_URL          = `http://localhost:8000/redirect?redirect_url=${encodeURIComponent(PORTAL_REDIRECT)}`;